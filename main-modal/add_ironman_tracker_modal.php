...
echo'<script>';
    echo'$(function() {';
      echo'$("#ironman_date").daterangepicker({';
        echo'singleDatePicker: true,';
        echo'locale: {';
          echo'format: "Y-MM-DD"';
        echo'}';
      echo'});';
      echo'$("#ironman_start").daterangepicker({';
    ...
    echo '<div class="ui form">';
      echo '<div class="equal width fields">';
        echo '<div class="field">';
          ...
          echo '<input id="ironman_date" type="text" name="text"  value="">';
        echo '</div>';
        echo '<div class="field">';
          echo '<label>Ticket Number</label>';
          echo '<input id="ironman_ticket" type="number" placeholder="Ticket Number">';
        echo '</div>';
        echo '<div class="field">';
          echo '<label>Account</label>';
          echo '<input id="ironman_account" type="text" placeholder="Account">';
        echo '</div>';
        echo '<div class="field">';
        echo '<label>Issue</label>';
        echo '<input id="ironman_issue" type="text" placeholder="Issue">';
        echo '</div>';
      echo '</div>';
      echo '<div class="equal width fields">';
        echo '<div class="field">';
          echo '<label>Start Time</label>';
          echo '<input id="ironman_start" type="text" name="text"  value="">';
        echo '</div>';
        echo '<div class="field">';
          echo '<label>Handling Team</label>';
          echo '<input id="ironman_team" type="text" placeholder="Handling Team">';
        echo '</div>';
        echo '<div class="field">';
          echo '<label>Cause</label>';
          echo '<input id="ironman_cause" type="text" placeholder="Cause">';
        echo '</div>';
        echo '<div class="field">';
          echo '<label>Internal/External</label>';
          echo '<input id="ironman_InternalExternal" type="text" placeholder="Internal/External">';
        echo '</div>';
      echo '</div>';
      echo '<div class="equal width fields">';
        echo '<div class="field">';
          echo '<label>Resolution</label>';
          echo '<textarea id="ironman_resolution"></textarea>';
        echo '</div>';
      echo '</div>';
      echo '<div class="actions">';
        echo '<button id="btn_saveupdate_ironman" class="save" type="button"><i class="ui checkmark icon"></i> Save</button>';
